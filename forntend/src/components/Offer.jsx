...
const Offer = () => {
  return (
    <section className='max-padd-container bg-banneroffer be-center bg-cover w-full'>
      <div className='px-4 py-16 md:py-24 lg:py-44'>
        <h2 className='h2'>Spring Sale 50% Off!</h2>
        <h3 className='medium-32 capitalize font-normala'>Grab <span className='text-secondary'>Your Favorites </span> Before They're Gone</h3>
