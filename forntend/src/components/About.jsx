    ...
    <section className='max-padd-container py-12 xl:py-32'> 
        ...
        <div className='flex flex-col gap-16 xl:gap-8 xl:flex-row'> 
            <div className='flex-1'>
                ...
                <p className='py-5'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor suscipit iusto assumenda. Doloribus, assumenda quidem? Assumenda sint eos voluptate voluptas delectus molestiae voluptates doloremque harum pariatur neque, doloribus nesciunt reiciendis!</p>
